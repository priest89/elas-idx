...
public class ChannelQuery {
	...
	public Long getChannelQueryId() {
		return channelQueryId;
	}

	public void setChannelQueryId(Long channelQueryId) {
		this.channelQueryId = channelQueryId;
	}
